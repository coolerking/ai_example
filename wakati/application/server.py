...
class WakatiHandler(tornado.web.RequestHandler):
    ...
    def post(self):
        ...
        # list型式で受領するため１件めを指定
        data = self.get_arguments("input_text")[0]
...
class Application(tornado.web.Application):
    ...
    def __init__(self):
        ...
        settings = dict(
            ...
            cookie_secret=os.environ.get("SECRET_TOKEN", "2|9fa7e217|e04f1b3c56a03dbc33792261e904c9d5|1503577552"),
            #cookie_secret="2|9fa7e217|e04f1b3c56a03dbc33792261e904c9d5|1503577552",
            xsrf_cookies=True,
            # デバッグオプション
            debug=True,
        )
